...
namespace DependencyAnalyzer
{
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            var analyzerPackagesPath = "/Users/vincent/not_in_cloud/Codes/KTH/acr-static-analysis-code/nuget_packages.txt";
            var analyzerPackages = File.ReadAllLines(analyzerPackagesPath);
            var repo = new LocalPackageRepository("/Users/vincent/not_in_cloud/Codes/KTH/acr-static-analysis-code/nuget_analyzer_packages");
            ...
            File.WriteAllText("/Users/vincent/not_in_cloud/Codes/KTH/acr-static-analysis-code/nuget_deps.json", outputObjectJson);
        }
