...
analysis_files = [f.name for f in os.scandir(analysis_dir) if f.is_file() and not f.name == ".DS_Store"]
...
for diff_file in diff_files:
    ...
    for patched_file in patch_set:
        ...
        with open(f"{repo_dir}/{patched_file.path}") as f:
            ...
            refined_data["NumberFileLines"] = len(list(refined_data["FileContent"]))
        ...
        for xml_project in projects_analysed:
            for xml_diagnostic in xml_project.find('Diagnostics'):
                ...
                analyzed_file_filepath = xml_diagnostic.find('FilePath').text[len(analyzed_file_prefix):].replace("\\", "/")
